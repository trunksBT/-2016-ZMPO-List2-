...
std::vector<std::string> setName0 = { "setName", "0", "newNameOfCPoint" };
std::vector<std::string> setName6 = { "setName", "6", "newNameOfCPoint" };
std::vector<std::string> setName10 = { "setName", "10", "newNameOfCPoint" };
