...
extern std::vector<std::string> setSize_0_5;
extern std::vector<std::string> setSize_m1_5;
extern std::vector<std::string> setSize_0_m5;
...
extern std::vector<std::string> getNamem;
...
extern std::vector<std::string> getSize10;
...
extern std::vector<std::string> setName6;
extern std::vector<std::string> setName10;
...
extern std::vector<std::string> setSizeToSmall;
...
extern std::vector<std::string> getValueToBig_1_23_3_4_5;
...
extern std::vector<std::string> setSizeToBig;
}
...
extern std::vector<std::string> setSizeZZ;
}
